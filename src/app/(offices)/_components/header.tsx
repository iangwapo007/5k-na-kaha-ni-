        ...
        <div className="flex h-full gap-x-2 mb-3 flex-between items-center flex-nowrap pl-3 pr-8">
          <div className="flex-grow justify-start">
            <button
              ...
              className="flex-shrink flex items-center px-2 py-1 text-sm font-medium text-slate-800 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-slate-300"
            >
              <ListIcon />
            </button>
          </div>
          <button
            onClick={toggleShown}
            className="flex-shrink flex flex-nowrap relative"
          >
              ...
              <>
                <div className="flex-grow justify-end text-right">
                  ...
                  <div className="text-xs text-slate-700 capitalize">
                    ...
                    (session?.user?.highestPosition ===
                      HighestPosition.President ||
                      session?.user?.highestPosition ===
                        HighestPosition.VicePresident)
                      ? session?.user?.highestPosition

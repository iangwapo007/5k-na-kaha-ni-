...
export default function ForwardedMemoLetter({ doctype, searchParam }: Readonly<{ doctype: DocumentType, searchParam: string }>) {
  ...
  const getData = useCallback(() => {
    const url = new URL('/' + Roles.Admin + '/api/memo/forwarded', window.location.origin)
